      ...
      <main className="flex-1 p-8">
        ...
        <header className="mb-8">
          ...
          <p className="text-neutral-500 mt-2">
            Find and complete food pickups in your area.
          </p>
        </header>
      ...
      {donations.length === 0 ? (
        ...
        donations.map((donation) => (
          ...
          >
            ...
            <p className="text-sm text-neutral-700 bg-neutral-100 p-3 rounded-lg flex items-center gap-2 mb-4">
              <Map size={16} />
              {donation.pickupLocation}
            </p>

            <p className="text-sm font-medium mb-4">
              Window: {donation.pickupWindow}
            </p>
...
function ActiveDeliveries() {
  ...
  const handleVerify = async () => {
    try {
      await api.post("/deliveries/verify-otp", {
        deliveryId,
        otpCode: otp
      });
    ...
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100">
      ...
      <div className="space-y-4 max-w-sm">
        ...
        <input
          ...
          className="w-full h-11 px-4 rounded-xl border border-neutral-200 outline-none focus:ring-primary"
          value={deliveryId}
