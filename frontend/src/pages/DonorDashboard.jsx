  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex">
      ...
      <aside className="w-64 bg-white border-r border-neutral-200 p-6 flex flex-col h-screen sticky top-0">
        ...
        <Link to="/" className="flex items-center gap-2 mb-10 cursor-pointer">
      ...
      <main className="flex-1 p-8">
        ...
        <header className="mb-8 flex justify-between items-center">
          ...
          <Button onClick={() => navigate('/donor-dashboard/create')}>
            ...
            element={
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100">
                ...
                <p className="text-neutral-500">
                  You can see all your posted donations here.
                </p>
              </div>
            }
          />
    ...
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            type="text"
            className="w-full h-11 px-4 rounded-xl border border-neutral-200 outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary"
            required
            value={formData.foodType}
            onChange={(e) =>
              setFormData({ ...formData, foodType: e.target.value })
            }
            placeholder="e.g., 50 boxes of cooked rice and curry"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g., enough for 20 people"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Between 2 PM and 5 PM"
          />
        </div>
        ...
        <div>
          ...
          <input
            type="file"
            accept="image/*"
            className="w-full h-11 pt-2 px-4 rounded-xl border border-neutral-200 outline-none"
            onChange={(e) =>
